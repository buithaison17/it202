...
/* Tạo một view có tên view_users_firstname để hiển thị danh sách các người dùng
có họ “Nguyễn”. View này cần bao gồm các cột: user_id, username, full_name, email, created_at. */
...
INSERT INTO users(username, full_name, gender, email, password, birthdate, hometown) VALUES
('tron', 'Nguyễn Trôn', 'Nam', 'tron@gmail.com', '123', '1990-01-01', 'Hà Nội');

-- Thực hiện xóa nhân viên vừa thêm khỏi bảng User
delete from users
where user_id = 22;
